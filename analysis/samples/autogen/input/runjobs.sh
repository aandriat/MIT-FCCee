...
generationDir=/afs/cern.ch/work/a/aandriat/public/MIT-FCCee/analysis/samples/autogen
...
cp -r $generationDir/input  . #change this to the path of input folder
...
function whizstart {
	source ${scramdir}/src/whizard/bin/whizard-setup.sh
}
back
