...
folder=/afs/cern.ch/work/a/aandriat/public/MIT-FCCee/analysis/samples #DDD #Do not chage after running setup.sh
src=/afs/cern.ch/user/a/aandriat/CMSSW_7_6_3/src #Do not change after running setup.sh
whizard=whizard #Do not change after running setup.sh
pythia=pythia8215 #Do not change after running setup.sh
