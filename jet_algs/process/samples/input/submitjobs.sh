...
outputDir=/afs/cern.ch/work/a/aandriat/public/jet_algs/antikt_inclusive/samples/output #change to your desired output location
...
script=/afs/cern.ch/work/a/aandriat/public/jet_algs/antikt_inclusive/samples/input/runjobs.sh 
