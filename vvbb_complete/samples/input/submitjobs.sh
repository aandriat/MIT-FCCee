...
maxEvents=100000
perJob=10000
process=ee_uuh_zh #AAA
cme=350 #BBB
numJobs=$((maxEvents/perJob))
outputDir=/afs/cern.ch/work/a/aandriat/public/eebb/final/350/samples/output #change to your desired output location
...
script=/afs/cern.ch/work/a/aandriat/public/eebb/final/350/samples/input/runjobs.sh 
