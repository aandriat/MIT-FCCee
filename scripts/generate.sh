...
folder=/afs/cern.ch/work/a/aandriat/public/test/MIT-FCCee #DDD #Do not chage after running setup.sh
src=/afs/cern.ch/user/a/aandriat/CMSSW_7_6_3_patch2/src #Do not change after running setup.sh
whizard=whizard/build #Do not change after running setup.sh
pythia=pythia/pythia8212 #Do not change after running setup.sh
delphes=delphes #Do not change after running setup.sh
...
#Do not change
xsec=0.0 #Actual value will be read from .lhe file and printed to terminal
